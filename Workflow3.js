...
export let options = {
    // vus:5
    stages: [
      { duration: '10s', target: 5 }, //ramp up 2 user 5 min
      { duration:'5m', target: 5 } //duration of run
    ],
};
...
export default function () {
  ...
  if(map1[username] == null){
    map1[username] = orderlist(host, order_cod, cookie);// GetID Order from orderlist
    sleep(basic_delay);
  }
